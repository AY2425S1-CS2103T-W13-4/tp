...
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete n/Alex")]),_v(" command to delete the person named Alex in the address book. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("StaticContext#setPersonToDelete(person)")]),_v(", storing the person to be deleted in a static context. The user then confirms the deletion with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete-y")]),_v(", causing the person to be removed from the address book and the modified state to be saved.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 21:05:44 GMT+8]")])])])}
}];
